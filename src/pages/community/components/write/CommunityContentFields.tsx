      ...
      <fieldset className="mt-[11px]">
        ...
        <div className="relative mt-[12px]">
          <textarea
            ...
            aria-label="게시글 내용"
            className="h-[158px] w-full resize-none rounded-[10px] border border-transparent bg-background-200 px-[20px] py-[12px] text-h2-onboard text-background-600 outline-none transition-colors duration-150 placeholder:text-background-400 hover:bg-background-100 focus:border-main-400 focus:bg-background-100"
          />
          {!content && (
