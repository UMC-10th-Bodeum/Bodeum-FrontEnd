...
export default function CommunityReplyItem({ reply, onReplyClick }: CommunityReplyItemProps) {
  return (
    <div className="relative ml-[18px] mt-[16px] pl-[42px] before:absolute before:left-0 before:top-0 before:h-[25px] before:w-[25px] before:border-b before:border-l before:border-background-250">
