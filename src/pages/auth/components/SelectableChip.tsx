  ...
  return (
    <button
      ...
      className={joinClassNames(
        "max-w-full shrink-0 cursor-pointer rounded-[120px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-main-400",
        buttonClassName,
      )}
    >
      <Chip
