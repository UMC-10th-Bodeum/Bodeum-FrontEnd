...
export const sidoDisplayNameByRegion: Record<string, string> = {
  서울특별시: "서울시",
  부산광역시: "부산시",
  대구광역시: "대구시",
  인천광역시: "인천시",
...
export const formatRegionDisplayLabel = (region: string) => {
  const [sido, ...restRegion] = region.split(" ");
  const displaySido = sidoDisplayNameByRegion[sido] ?? sido;

  return [displaySido, ...restRegion].join(" ");
};

export const districtNamesByRegion: Record<string, string[]> = {
  서울특별시: [
    "강남구",
    "강동구",
    "강북구",
